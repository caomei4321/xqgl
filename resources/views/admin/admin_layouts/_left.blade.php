...
{{--                    <span><img alt="image" class="img-circle" src="{{ asset('assets/admin/img/profile_small.jpg') }}" /></span>--}}
            ...
            @if(auth()->user()->can('admin\patrolMatters') || auth()->user()->can('admin\patrols'))
            <li>
            ...
            @endif
            @if(auth()->user()->can('admin\matters') || auth()->user()->can('admin\situations'))
            <li>
            ...
            @endcan
            @if(auth()->user()->can('admin\categories') || auth()->user()->can('admin\responsibility') || auth()->user()->can('admin\governanceStandard') || auth()->user()->can('admin\part') || auth()->user()->can('admin\corrdinates'))
            <li>
            ...
            @endif
            @if(auth()->user()->can('admin\administrators') || auth()->user()->can('admin\roles') || auth()->user()->can('admin\permissions'))
            <li>
