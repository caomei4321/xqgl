                    ...
                    <div class="ibox-content">
                        <form method="get" class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <p class="form-control-static deviceSerial">{{ $ret->matter->work_num }}</p>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <p class="form-control-static deviceSerial">{{ $ret->matter->accept_num }}</p>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <p class="form-control-static deviceSerial">{{ $ret->matter->level }}</p>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <p class="form-control-static deviceSerial">{{ $ret->matter->contact_name }}</p>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <p class="form-control-static deviceSerial">{{ $ret->matter->phone }}</p>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <p class="form-control-static deviceSerial">{{ $ret->matter->category }}</p>
                                </div>
                            </div>
                            <div class="form-group">
