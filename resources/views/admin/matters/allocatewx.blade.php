        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form method="POST" action="{{ route('admin.people.allocates') }}" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">选择任务类别：</label>
                            <div class="col-sm-6">
                                <select class="form-control chosen-select" name="responsibility_id" tabindex="2" required>
